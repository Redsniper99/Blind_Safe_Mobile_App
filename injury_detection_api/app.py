...
def upload_to_gemini(image_path, text):
    ...
    convo.send_message(f"here image that i provide is {text} wound, now i want to get small description status about the wound like what kind of wound 30 words? do not provide too much text just small description i need paragraph do not pointform?")
